        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 text-gray-600">
                ...
                <li className="flex items-center gap-2">
                  <span className="text-blue-600">✔</span> UX/UI 설계
                </li>
                <li className="flex items-center gap-2">
                  <span className="text-blue-600">✔</span> 프론트엔드 개발
                </li>
                <li className="flex items-center gap-2">
                  <span className="text-blue-600">✔</span> FastAPI API 구현
                </li>
                <li className="flex items-center gap-2">
                  <span className="text-blue-600">✔</span> 배포 및 운영 점검 (Vercel / AWS EC2)
                </li>
              </ul>
            </div>
            ...
            <div className="p-4 rounded-lg bg-blue-50 border-l-4 border-blue-600 text-sm text-blue-900">
              임팩트: AI 응답과 추천 결과 흐름을 정리해 추천 UI와 상태 관리의
              일관성을 높였습니다.
            </div>
